...
└── Shared/`}
      ...
      <LessonChecklist
        ...
        id="aspnet-openapi-validation-checklist"
        items={[
          "用 FluentValidation 为 CreateUserDto 写验证器并全局注册",
          "比较 Data Annotations 与 FluentValidation 的跨字段验证写法",
          "用 Minimal API + MapGroup 写一组登录/获取用户端点",
          "添加 Swagger 文档并配置 JWT 认证（Bearer）支持",
