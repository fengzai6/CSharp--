...
public async Task<IActionResult> DeleteGroup(string id) { ... }`}
      ...
      <LessonChecklist
        ...
        id="aspnet-controller-di-checklist"
        items={[
          "实现 User CRUD API，Controller + Service + DTO 三层分离",
          "用构造函数注入 IUserService，并在 Program.cs 中 AddScoped 注册",
          "为 GetAll 端点加上 page/pageSize/search 查询参数绑定",
          "配置 JWT 认证，给删除端点加 [Authorize(Policy = \"AdminOnly\")]",
          "写一个自定义授权 Handler（如资源所有者校验）并注册",
        ]}
        title="实战练习清单"
